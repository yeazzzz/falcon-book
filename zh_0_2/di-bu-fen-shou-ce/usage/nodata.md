...
进入Nodata配置主页，可以看到Nodata配置列表 ![nodata.list](../../.gitbook/assets/func\_nodata\_1.png)

点击右上角的添加按钮，添加nodata配置。 ![nodata.config](../../.gitbook/assets/func\_nodata\_2.png)
...
![nodata.template](../../.gitbook/assets/func\_nodata\_3.png)
